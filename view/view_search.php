<?
	...
	echo "<table class=table1><form id=search_form action=".$current_file_name."?here=".$here."&mode=confirm_search&class_obj=".$class_obj."&module=".$module."&viewType=".$viewType." method=post>";
	...
	foreach($w_columns as $wcolumns_key => $wcolumns_value)
	{
		...
		{
			echo "<tr><td>".rm_vf1x($wcolumns_key)."<td><input type=text id='input_".$wcolumns_key."' name='input_".$wcolumns_key."' value='".$_REQUEST['input_'.$wcolumns_key]."'>";
